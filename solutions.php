    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            height: 100vh; /* CHANGED: Lock to viewport height */
            display: flex;
            flex-direction: column;
            overflow: hidden; /* CHANGED: Disable scroll to fit one page */
        }
        ...
        /* --- SOLUTIONS CONTENT --- */
        .solutions-hero { padding: 40px 5% 20px 5%; text-align: center; max-width: 1200px; margin: 0 auto; }
        .solutions-hero h1 { font-size: 2.8rem; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 3px; }
        .solutions-hero p { color: var(--brand-green); font-weight: 700; letter-spacing: 2px; font-size: 1rem; }
        
        .solutions-grid { 
            display: grid; 
            grid-template-columns: repeat(3, 1fr); /* CHANGED: Fixed 3 columns for desktop */
            gap: 20px; 
        ...
        .solution-card:hover { border-color: var(--brand-green); transform: translateY(-10px); background: rgba(255, 255, 255, 0.08); box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4); }
        
        .card-icon { font-size: 2.5rem; color: var(--brand-green); text-shadow: 0 0 15px rgba(74, 222, 128, 0.3); }
        .tag { font-size: 0.65rem; font-weight: 900; background: rgba(74, 222, 128, 0.2); color: var(--brand-green); padding: 5px 12px; border-radius: 50px; width: fit-content; text-transform: uppercase; }
        .solution-card h3 { font-size: 1.4rem; color: var(--brand-gold); letter-spacing: 1px; }
        .solution-card p { font-size: 0.85rem; line-height: 1.5; color: #d1d9e0; }
        
        .feature-list { list-style: none; margin-top: 5px; }
        .feature-list li { font-size: 0.75rem; margin-bottom: 6px; display: flex; align-items: center; gap: 10px; color: var(--brand-green); font-weight: 600; }
        
        .automation-bar { background: rgba(37, 211, 102, 0.1); border: 1px solid rgba(37, 211, 102, 0.3); border-radius: 15px; padding: 15px; margin-top: auto; display: flex; align-items: center; gap: 12px; }
        .automation-bar i { color: #25D366; font-size: 1.3rem; }
        .automation-text { font-size: 0.65rem; font-weight: 700; color: #fff; text-transform: uppercase; }
        
        footer { padding: 15px; background: #000b1a; text-align: center; font-size: 0.6rem; color: rgba(255,255,255,0.4); border-top: 1px solid rgba(255,255,255,0.05); }

        /* --- RESPONSIVENESS --- */
        @media (max-width: 900px) {
            body { height: auto; overflow: auto; } /* Allow scroll on mobile */
