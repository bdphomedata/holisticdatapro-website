...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- NAVIGATION (SYNCHRONIZED WITH INDEX.HTML) --- */
        nav { 
            width: 100%; 
            padding: 0.8rem 3%; 
        ...
        /* Fixed Font Styling for consistency */
        ...
        .solution-card { background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 20px; padding: 40px; backdrop-filter: blur(15px); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); display: flex; flex-direction: column; gap: 20px; position: relative; overflow: hidden; }
        ...
        .automation-bar { background: rgba(37, 211, 102, 0.1); border: 1px solid rgba(37, 211, 102, 0.3); border-radius: 15px; padding: 20px; margin-top: auto; display: flex; align-items: center; gap: 15px; }
